...
export const App: React.FC<AppProps> = ({ hostRuntime }) => {
  ...
  return (
    <div className={`app-container theme-${theme}`}>
      {currentScreen === 'search' && <Search {...screenProps} />}
      {currentScreen === 'results' && <Results {...screenProps} />}
      {currentScreen === 'passengers' && <Passengers {...screenProps} />}
      {currentScreen === 'services' && <Services {...screenProps} />}
      {currentScreen === 'payment' && <Payment {...screenProps} />}
      {currentScreen === 'checkout' && <Checkout {...screenProps} />}
      {currentScreen === 'done' && <Done {...screenProps} />}
    </div>
  );
};
