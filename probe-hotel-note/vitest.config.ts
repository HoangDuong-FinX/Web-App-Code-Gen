...
export default defineConfig({
  ...
  test: {
    ...
    globals: true,
    // Registers the DOM matchers. Without this line `toBeInTheDocument` is a
    // type error under `tsc -b` AND an "Invalid Chai property" at runtime; see
    // the note above _TEST_SETUP.
