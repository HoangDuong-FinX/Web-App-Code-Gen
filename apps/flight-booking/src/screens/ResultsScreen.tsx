...
export function ResultsScreen({ navigate }: ResultsScreenProps) {
  ...
  function handleContinue() {
    ...
    if (state.tripType === 'roundTrip') { navigate('results-return'); } else { navigate('passengers'); }
  }
