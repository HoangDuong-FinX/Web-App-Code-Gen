...
export default function ReservationSuccessScreen({ onNavigate, params }: ReservationSuccessScreenProps): React.JSX.Element {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-8 gap-4">
      <img
        ...
        alt={t('reservationSuccess.imageAlt')}
        className="w-30 h-30"
        data-testid="success-illustration"
      />
      <h1 className="text-2xl font-bold text-gray-900 text-center">{t('reservationSuccess.title')}</h1>
      <p className="text-gray-600 text-center">{t('reservationSuccess.message')}</p>
      <button
        type="button"
