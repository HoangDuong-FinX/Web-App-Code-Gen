    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="p-4 flex flex-col gap-1">
        ...
        <input
          ...
          aria-label={t('tdDatetime.selectDateAria')}
            ...
            <div className="flex flex-wrap gap-2">
              {slots.map(slot => (
                <button
                  key={slot.time}
                  type="button"
                  onClick={() => !slot.isUnavailable && setSelectedTime(slot.time)}
      ...
      {slotError && (
        <p className="mx-4 text-sm text-red-600 bg-red-50 p-3 rounded-lg" aria-live="polite" data-testid="slot-error">{t('tdDatetime.slotError')}</p>
      )}
      ...
      <div className="p-4 mt-auto">
        <button
          ...
          aria-label={t('tdDatetime.continueAria')}
