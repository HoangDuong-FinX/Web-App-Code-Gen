...
describe("Catalog screen", () => {
  it("renders catalog with car listings", () => {
    render(<App />);
    expect(screen.getByRole("heading", { level: 1, name: /danh m\u1ee5c|car catalog/i })).toBeTruthy();
  ...
  it("navigates to car detail when car clicked", () => {
    ...
    expect(screen.getByRole("heading", { name: /th\u00f4ng s\u1ed1|specifications/i })).toBeTruthy();
  });
});
...
describe("Car detail screen", () => {
  ...
  it("navigates to test drive booking", () => {
    ...
    expect(screen.getByRole("heading", { level: 1, name: /\u0111\u1eb7t l\u00e1i th\u1eed|request test drive/i })).toBeTruthy();
  });
  ...
  it("navigates to purchase inquiry", () => {
    ...
    expect(screen.getByRole("heading", { level: 1, name: /\u0111\u1eb7t gi\u00e1|make an offer/i })).toBeTruthy();
  });
...
describe("Navigation tabs", () => {
  it("navigates to favorites tab", () => {
    ...
    expect(screen.getByRole("heading", { level: 1, name: /xe y\u00eau th\u00edch|my favorites/i })).toBeTruthy();
  });
  ...
  it("navigates to activity tab", () => {
    ...
    expect(screen.getByRole("heading", { level: 1, name: /ho\u1ea1t \u0111\u1ed9ng|my activity/i })).toBeTruthy();
  });
  ...
  it("shows admin tab when staff mode is on", () => {
    ...
    expect(screen.getByRole("heading", { level: 1, name: /b\u1ea3ng \u0111i\u1ec1u khi\u1ec3n|staff dashboard/i })).toBeTruthy();
  });
});
...
describe("Admin flow", () => {
  ...
  it("navigates to inventory management", () => {
    ...
    expect(screen.getByRole("heading", { level: 1, name: /qu\u1ea3n l\u00fd kho|inventory management/i })).toBeTruthy();
  });
  ...
  it("navigates to inquiry management", () => {
    ...
    expect(screen.getByRole("heading", { level: 1, name: /qu\u1ea3n l\u00fd y\u00eau c\u1ea7u|inquiry management/i })).toBeTruthy();
  });
});
